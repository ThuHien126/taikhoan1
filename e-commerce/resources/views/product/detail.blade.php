<style>
   ...
   .active{
    border: 2px solid rgb(100, 136, 234) !important;
   }
                            ...
                            <div class="col-lg-10 order-lg-2">
                                <div class="single-product-thumbnail-wrap zoom-gallery">
                                    <div class="single-product-thumbnail product-large-thumbnail-3 axil-product">
                                        ...
                                        <div class="thumbnail">
                                            <a href="{{ asset('images/product/electric/' . $product_item->product_image) }}" class="popup-zoom">
                                                <img src="{{ asset('images/product/electric/' . $product_item->product_image) }}" alt="Product Images">
                                            </a>
                                        </div>
                                        @endforeach
                                        {{-- <div class="thumbnail">
                                            <a href="{{ asset('images/product/electric/' . $product->product_image) }}" class="popup-zoom">
                                                <img src="{{ asset('images/product/electric/' . $product->product_image) }}" alt="Product Images">
                                            </a>
                                        </div>
                                        <div class="thumbnail">
                                    ...
                                    @if ( $product_item->discount_rate)
                                    <div class="label-block">
                                        <div class="product-badget">{{ $product_item->discount_rate * 100 }}% OFF</div>
                                    </div>
                                    @endif
                            ...
                            <div class="col-lg-2 order-lg-1">
                                <div class="product-small-thumb-3 small-thumb-wrapper">
                                    ...
                                    <div class="small-thumb-img">
                                        <img src="{{ asset('images/product/electric/' . $product_item->product_image) }}" alt="thumb image">
                                    </div>
                                    @endforeach
                                    {{-- <div class="small-thumb-img">
                    ...
                    <div class="col-lg-5 mb--40">
                        <div class="single-product-content">
                            <div class="inner">
                                ...
                                @csrf
                                    <!-- Hidden inputs -->
                                    <input type="hidden" name="product_item_id" id="product-item-id">
                                    ...
                                    <div class="product-variations-wrapper">
                                        ...
                                        <div class="product-variation">
                                            <h6 class="title">Tùy chọn: </h6>
                                            <div class="color-variant-wrapper">
                                                <ul class="color-variant">
                                                    @for ($i = 0; $i < count($product_items); $i++)
                                                    <li class="option color" data-color="{{ $product_items[$i]->color }}" data-storage="{{ $product_items[$i]->storage }}"  data-id="{{ $product_items[$i]->id }}" onclick="selectProductItem(this)">
                                                        {{-- <div id="product-item-id">{{ $product_items[$i]->id }}</div> --}}
                                                        <div class="d-flex">
                                                            <?php $image = $product_items[$i]->product_image ?>
                                                            <img style="width: 60px;" src="{{ asset('images/product/electric/' . $image) }}" alt="">
                                                            <div>
                                                                <span class="color">{{ $product_items[$i]->color }} <span>128GB</span></span>
                                                                <br>
                                                                {{-- <span><span class="price">{{ number_format($product_items[$i]->price, 0, ",", ".") }}</span>đ</span> --}}
                                                                @if ($product_items[$i]->discount_rate)
                                                                    <span class="price">{{ number_format($product_items[$i]->price * (1 -$product_items[$i]->discount_rate), 0, ",", ".") }} đ</span>
                                                                @else
                                                                    <span class="price">{{ number_format($product_items[$i]->price, 0, ",", ".") }} đ</span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </li>
                                    ...
                                    <div class="product-action-wrapper d-flex-center">
                                        ...
                                        <div class="pro-qty"><input type="text" name="quantity" id="qty" value="1"></div>
                                        <!-- End Quentity Action  -->

                                        <!-- Start Product Action  -->
                                        <ul class="product-action d-flex-center mb--0">
                                            <button class="axil-btn btn-bg-primary" type="submit"><li class="add-to-cart" style="color: white; font-size: 22">Thêm giỏ hàng</li></button>
                                        </ul>
                                        <!-- End Product Action  -->
...
@endsection
<script>
    let liColors = document.querySelectorAll('.color');
    function selectProductItem(element) {
        // Lấy ID sản phẩm từ data attribute
        const productItemId = element.getAttribute('data-id');
        const productItemColor = element.getAttribute('data-color');
        const productItemStorage = element.getAttribute('data-storage');
        // const qty = document.getElementById('qty').value;
        // console.log(qty);

        document.getElementById('product-item-id').value = productItemId;
        document.getElementById('color').value = productItemColor;
        document.getElementById('storage').value = productItemStorage;

        // Xóa lớp active cũ (nếu có)
        liColors.forEach(item => {
