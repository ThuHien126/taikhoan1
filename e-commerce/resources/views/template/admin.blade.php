...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Apr 2025 06:56:19 GMT -->
<head>
            ...
            <div class="page-sidebar">
                ...
                <div class="sidebar custom-scrollbar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a class="sidebar-header" href="{{ route("admin.coupon")}}">
                                ...
                                <ul class="list">
                                    <li class="clearfix">
                                        <img class="rounded-circle user-image blur-up lazyloaded"
                                            src="{{ asset('') }}assets/images/dashboard/user.jpg" alt="">
...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Apr 2025 06:56:36 GMT -->
</html>